class CategoryTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @category_type.save
        format.html { redirect_to @category_type, notice: 'Categoria criada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @category_type.update(category_type_params)
        format.html { redirect_to @category_type, notice: 'Categoria atualizada com sucesso.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to category_types_url, notice: 'Categoria apagada com sucesso.' }
  ...
  private
    ...
    def category_type_params
      params.require(:category_type).permit(:name, :category_id)
    end
end
